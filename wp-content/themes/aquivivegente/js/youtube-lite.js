    ...
    switch (
      ...
      case "videoid": {
        if (
          ...
          if (
            this.__domRefFrame.classList.contains(
              "lyt-activated"
            )
          ) {
            this.__domRefFrame.classList.remove(
              "lyt-activated"
            );
            this.shadowRoot
              .querySelector(
...
></iframe>`;
      ...
      this.__domRefFrame.classList.add(
        "lyt-activated"
      );
  ...
  __initImagePlaceholder() {
    ...
    this.__domRefImg.webp.srcset =
      posterUrlWebp;
    this.__domRefImg.jpeg.srcset =
      posterUrlJpeg;
    this.__domRefImg.fallback.src =
      posterUrlJpeg;
